...
export default function Footer() {
  return (
    <div className='bg-[#E7ECFF] py-10 sm:py-20'>
        <div className='w-[90%] max-w-[1100px] m-auto'>
            <div className="flex sm:flex-row flex-col-reverse sm:gap-0 gap-5 justify-between items-center">
                ...
                <button className="sm:block hidden text-white bg-[#111B47] px-6 py-[6px] rounded-sm text-xs">Purchase Now</button>
            </div>
            <div className='w-full h-[1px] bg-[#CDD1D4] my-5'></div>
            <div className="flex sm:flex-row flex-col sm:gap-0 gap-8 justify-between items-center">
